...
nodes.and.links$links$value<-floor((scale(nodes.and.links$links$value)-min(scale(nodes.and.links$links$value))+1)*4)

##Take out links of the same:

nodes.JSON<-dfToJSON(nodes.and.links$nodes, 'rowToObject')
links.JSON<-dfToJSON(nodes.and.links$links, 'rowToObject')
