...
with open("P:/R repositories/General-work/football team js/gameweek-dates.txt","r") as f:
    for line in f:
        dat = line.split('\t')
        dat[1] = dat[1].strip('\n')
...
##Lets request the data to make sure its there:
    
requests.get(http_start+http_type, params=api).text


# In[12]:

##Using pymongo lets have alook at whats in the database
